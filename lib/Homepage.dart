...
import 'package:itinerary/LocationDetailScreen.dart';
import 'dart:convert';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget buildPreferenceButton(
      BuildContext context, String title, String preference) {
    return Padding(
 ...
 void navigateToPOIs(BuildContext context, List<String> selectedPreferences) {
    ...
    List<dynamic> filteredPOIs =
        poiList.where((poi) => selectedPreferences.contains(poi['category'])).toList(); 
